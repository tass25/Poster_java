  ...
  return (
    <div className="bg-black pb-10">
      ...
      <header className="relative bg-black">
        <p className="flex h-10 items-center justify-center  bg-amber-500 px-4 text-sm font-medium text- sm:px-6 lg:px-8">
          Get free delivery NOW , Don't Miss The Chance
        </p>
                          ...
                          <div className="relative flex">
                            <Popover.Button
                              className={classNames(
                                open
                                  ? "border-indigo-200  text-yellow-500"
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  {auth.user ? (
                    ...
                    <Button
                      onClick={handleOpen}
                      className="text-sm font-medium hover:text-yellow-500 text-red-600"
                    >
                      Signin
                    </Button>
                  )}
