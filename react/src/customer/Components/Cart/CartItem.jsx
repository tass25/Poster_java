...
const CartItem = ({ item,showButton }) => {
  ...
  return (
    <div className="p-5 shadow-lg border-2 border-yellow-600 rounded-md">
      <div className="flex items-center">
        ...
        <div className="ml-5 space-y-1">
          ...
          <p className="opacity-70 mt-2">votes: {item?.product?.votes}</p>
          <div className="flex space-x-2 items-center pt-3">
            <p className="opacity-50 line-through"> TND {item?.product?.price}</p>
            <p className="font-semibold text-lg">
               TND {item?.product?.discountedPrice}
            </p>
