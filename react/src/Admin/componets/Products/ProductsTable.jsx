        ...
        <Grid container spacing={2}>
          <Grid item xs={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value={"pant"}>Horror</MenuItem>
                <MenuItem value={"comedy"}>Action</MenuItem>
                <MenuItem value={"saree"}>Comedy</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={4}>
